...
function upcomingMatches(team) {
    fetch( 'https://apiv3.apifootball.com/?action=get_leagues=153&country_id=6&APIkey=' + footballAPIkey)
    .then(function(resp) {
        return resp.json()
...
})//`https://apiv3.apifootball.com/?action=get_events&from=${today}&to=2023-03-08&league_id=153&APIkey=`